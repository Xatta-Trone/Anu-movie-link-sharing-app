...
part of 'tmdb_single_movie_result.dart';
...
TmdbSingleMovieResult _$TmdbSingleMovieResultFromJson(
    Map<String, dynamic> json) {
  return _TmdbSingleMovieResult.fromJson(json);
}

/// @nodoc
mixin _$TmdbSingleMovieResult {
  @JsonKey(name: "adult")
  ...
  @JsonKey(ignore: true)
  $TmdbSingleMovieResultCopyWith<TmdbSingleMovieResult> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TmdbSingleMovieResultCopyWith<$Res> {
  factory $TmdbSingleMovieResultCopyWith(TmdbSingleMovieResult value,
          $Res Function(TmdbSingleMovieResult) then) =
      _$TmdbSingleMovieResultCopyWithImpl<$Res, TmdbSingleMovieResult>;
  @useResult
  $Res call(
...
/// @nodoc
class _$TmdbSingleMovieResultCopyWithImpl<$Res,
        $Val extends TmdbSingleMovieResult>
    implements $TmdbSingleMovieResultCopyWith<$Res> {
  _$TmdbSingleMovieResultCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$TmdbSingleMovieResultImplCopyWith<$Res>
    implements $TmdbSingleMovieResultCopyWith<$Res> {
  factory _$$TmdbSingleMovieResultImplCopyWith(
          _$TmdbSingleMovieResultImpl value,
          $Res Function(_$TmdbSingleMovieResultImpl) then) =
      __$$TmdbSingleMovieResultImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "adult") bool? adult,
...
/// @nodoc
class __$$TmdbSingleMovieResultImplCopyWithImpl<$Res>
    extends _$TmdbSingleMovieResultCopyWithImpl<$Res,
        _$TmdbSingleMovieResultImpl>
    implements _$$TmdbSingleMovieResultImplCopyWith<$Res> {
  __$$TmdbSingleMovieResultImplCopyWithImpl(_$TmdbSingleMovieResultImpl _value,
      $Res Function(_$TmdbSingleMovieResultImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$TmdbSingleMovieResultImpl(
      adult: freezed == adult
          ? _value.adult
          : adult // ignore: cast_nullable_to_non_nullable
              as bool?,
...
/// @nodoc
@JsonSerializable()
class _$TmdbSingleMovieResultImpl implements _TmdbSingleMovieResult {
  const _$TmdbSingleMovieResultImpl(
  ...
  factory _$TmdbSingleMovieResultImpl.fromJson(Map<String, dynamic> json) =>
      _$$TmdbSingleMovieResultImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$TmdbSingleMovieResultImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$TmdbSingleMovieResultImplCopyWith<_$TmdbSingleMovieResultImpl>
      get copyWith => __$$TmdbSingleMovieResultImplCopyWithImpl<
          _$TmdbSingleMovieResultImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$TmdbSingleMovieResultImplToJson(
      this,
    );
  }
}

abstract class _TmdbSingleMovieResult implements TmdbSingleMovieResult {
  const factory _TmdbSingleMovieResult(
  ...
  factory _TmdbSingleMovieResult.fromJson(Map<String, dynamic> json) =
      _$TmdbSingleMovieResultImpl.fromJson;
